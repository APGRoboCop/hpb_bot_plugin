...
// game start messages for WIZARD WARS...
#define MSG_WW_IDLE          1
#define MSG_WW_TEAM_SELECT   2
#define MSG_WW_CLASS_SELECT  3
...
#define MSG_SWARM_IDLE			1
#define MSG_SWARM_TEAM_SELECT   2
#define MSG_SWARM_CLASS_SELECT  3

enum{
	SWARM_CLASSID_GHOST			= 0,
	SWARM_CLASSID_ANY			= 0,	// Used by spawn points

	SWARM_H_START_CLASS			= 1,	// Used by team code to limit class selection
	SWARM_CLASSID_HGRUNT		= 1,
	SWARM_CLASSID_ASSASSINF		= 2,
	SWARM_CLASSID_SCIENTIST		= 3,
	SWARM_CLASSID_COMMANDER		= 4,
	SWARM_CLASSID_BARNEY		= 5,
	SWARM_CLASSID_HHERO			= 6,
	SWARM_H_END_CLASS			= 6,	// Used by team code to limit class selection

	SWARM_X_START_CLASS			= 10,	// Used by team code to limit class selection
	SWARM_CLASSID_XGRUNT		= 10,
	SWARM_CLASSID_SLAVE			= 11,
	SWARM_CLASSID_GARGANTUA		= 12,
	SWARM_CLASSID_CONTROLLER	= 13,
	SWARM_CLASSID_HEADCRAB		= 14,
	SWARM_CLASSID_ZOMBIE		= 15,
	SWARM_X_END_CLASS			= 15,	// Used by team code to limit class selection

	SWARM_CLASSID_RANDOM		= 19,
	SWARM_CLASSID_HUMAN			= 19,	// Used by spawn points, does not have random.
	SWARM_CLASSID_XEN			= 20	// Used by spawn points
};
...
// TheFatal - END
   ...
   int m_rgAmmo[MAX_AMMO_SLOTS];  //MAX_WEAPONS];// total ammo amounts (1 array for each bot)
